...
class Ui03 extends StatefulWidget {
  final String phoneNumber;

  const Ui03({super.key, required this.phoneNumber});

  @override
  State<Ui03> createState() => _Ui03State();
}

class _Ui03State extends State<Ui03> {
              ...
              children: [
                ...
                Row(
                  children: [
                    SvgPicture.asset(
                      isTimerOver
                          ? "assets/icons/others/error.svg"
                          : 'assets/icons/others/check_icon_grey.svg',
                    ),
                    SizedBox(width: 4.w),
                    Text(
                  ...
                  buttonEnabled
                      ? () {
                        Navigator.of(context).push(
                          MaterialPageRoute(builder: (context) => Home05Main()),
                        );
                      }
                      : null,
              child: Container(
