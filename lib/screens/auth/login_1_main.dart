...
import 'package:vybe/screens/auth/login_2_main.dart';

void main() {
  runApp(const Login1Main());
}

class Login1Main extends StatelessWidget {
  const Login1Main({super.key});
    ...
    return Column(
      children: [
        SocialLoginButton(
          ...
          iconPath: 'assets/icons/sso_login/kakao_icon.svg',
        ),
        ...
        SocialLoginButton(
          ...
          iconPath: 'assets/icons/sso_login/naver_icon.svg',
        ),
        SizedBox(height: 16.h),
        SocialLoginButton(
          color: Colors.white,
          ...
          iconPath: 'assets/icons/sso_login/apple_icon.svg',
        ),
                ...
                return SizedBox(
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        SvgPicture.asset(
                          'assets/icons/others/check_icon_green.svg',
                        ),
                        SizedBox(height: 24.h),
                        Text(
                          '본인 인증이 필요합니다.',
