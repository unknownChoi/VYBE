...
import 'package:vybe/constants/login_02_constants.dart';
import 'package:vybe/constants/AppColors.dart';
import 'package:vybe/screens/auth/consent_detail_page.dart';
import 'package:vybe/screens/auth/login_03_main.dart';
import 'package:vybe/screens/home_05_main.dart';
import 'package:vybe/services/firebase/firebase_service.dart';
import 'package:vybe/utils/loading_animation.dart';
import 'package:vybe/utils/ui02_%20validators.dart';
import 'package:vybe/widgets/auth/login_02_carrierfield.dart.dart';
import 'package:vybe/widgets/auth/login_02_inputfield.dart';
import 'package:vybe/widgets/auth/login_02_birthinput.dart';

class Login2Main extends StatefulWidget {
  const Login2Main({super.key});

  @override
  State<Login2Main> createState() => _Ui02MainState();
}

class _Ui02MainState extends State<Login2Main> {
      ...
      return Column(
        ...
        children: [
          ...
          Row(
            children: [
              SvgPicture.asset(
                'assets/icons/others/notice_icon.svg',
                color: messageColor,
                width: 16.w,
                height: 16.w,
              ),
                            ...
                            children: [
                              GestureDetector(
                                ...
                                child:
                                    isChecked
                                        ? SvgPicture.asset(
                                          'assets/icons/consent/checked.svg',
                                        )
                                        : SvgPicture.asset(
                                          'assets/icons/consent/unchecked.svg',
                                        ),
                              ),
                              SizedBox(width: 12.w),
                              Text(
                              ...
                              GestureDetector(
                                ...
                                child: SvgPicture.asset(
                                  'assets/icons/consent/more_consent.svg',
                                ),
                              ),
                            ],
                          ),
