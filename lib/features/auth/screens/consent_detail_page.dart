...
class ConsentDetailPage extends StatefulWidget {
  final String consentTitle;

  const ConsentDetailPage({super.key, required this.consentTitle});

  @override
  State<ConsentDetailPage> createState() => _ConsentDetailPageState();
}

class _ConsentDetailPageState extends State<ConsentDetailPage> {
  @override
